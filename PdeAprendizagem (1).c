    ...
    switch (escolha) {
        ...
        case 'V':
            ...
            if(troco > 0){
                ...
                if(quantidade > 0) printf("Notas de R$ 200: %d\n", quantidade);

                quantidade = troco / 100;
                troco -= quantidade * 100;
                if(quantidade > 0) printf("Notas de R$ 100: %d\n", quantidade);

                quantidade = troco / 50;
                troco -= quantidade * 50;
                if(quantidade > 0) printf("Notas de R$ 50: %d\n", quantidade);

                quantidade = troco / 20;
                troco -= quantidade * 20;
                if(quantidade > 0) printf("Notas de R$ 20: %d\n", quantidade);

                quantidade = troco / 10;
                troco -= quantidade * 10;
                if(quantidade > 0) printf("Notas de R$ 10: %d\n", quantidade);

                quantidade = troco / 5;
                troco -= quantidade * 5;
                if(quantidade > 0) printf("Notas de R$ 5: %d\n", quantidade);

                quantidade = troco / 2;
                troco -= quantidade * 2;
                if(quantidade > 0) printf("Notas de R$ 2: %d\n", quantidade);

                quantidade = troco / 1;
                troco -= quantidade * 1;
                if(quantidade > 0) printf("Moedas de R$ 1: %d\n", quantidade);

                quantidade = troco / 0.50;
                troco -= quantidade * 0.50;
                if(quantidade > 0) printf("Moeda de R$ 0.5: %d\n", quantidade);

                quantidade = troco / 0.25;
                troco -= quantidade * 0.25;
                if(quantidade > 0) printf("Moeda de R$ 0.25: %d\n", quantidade);

                quantidade = troco / 0.10;
                troco -= quantidade * 0.10;
                if(quantidade > 0) printf("Moeda de R$ 0.10: %d\n", quantidade);

                quantidade = troco / 0.05;
                troco -= quantidade * 0.05;
                if(quantidade > 0) printf("Moeda de R$ 0.05: %d\n", quantidade);

                quantidade = troco / 0.01;
                troco -= quantidade * 0.01;
                if(quantidade > 0) printf("Moeda de R$ 0.01: %d\n", quantidade);
